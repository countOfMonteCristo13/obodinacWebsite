    ...
    <>
      ...
      <div className='o__contactPage slide-enterance1'>
        ...
        <div className='headtext flex__center'>
          ...
          <p>
            U svakom trenutku smo dostupni i dolazimo na intervenciju u vreme koje Vama lično
            najviše odgovara. Naši majstori pokrivaju celu teritoriju grada. Intervenciju možete
            zakazati putem telefonskog poziva ili putem online zakazivanja, odnosno kontakt forme.
            Takođe, na oba navedena načina nas možete kontaktirati ukoliko Vam je potreban savet ili
            imate neku nedoumicu, kao i ukoliko imate pohvale ili kritike na naš rad, radi smo da
            saslušamo i na taj način dodatno unapredimo naše poslovanje. Poslujte sa ovlašćenim
            klima servisom, koji se klima uređajima bavi 24h!
          </p>
        </div>
