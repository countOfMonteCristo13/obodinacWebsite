		...
		<div className='o__footer'>
			...
			<div className='o__footer_info'>
				...
				<div className="info" >
					...
					<a target='_blank' rel="noreferrer" href="https://www.instagram.com/obodinacplus_klimatizacija/"><h5 className='cursor-pointer'>@obodinac_klimatizacija</h5></a>
				</div>

				<div className="info">
					<img src={images.emailIcon} alt='email' />
					<h5 ref={textToCopyRef} data-clipboard-text='klimatizacija.grejanje@gmail.com' className='cursor-copy'>klimatizacija.grejanje@gmail.com</h5>
				</div>
